...
public class WorkerController {
	...
	public String create() {
		try {
			Worker worker = new Worker(9, "Satyasri", "Sri", 65000,Date.valueOf("2022-02-24"), "SDE", "satya@org.in");
	...
	public String update() {
		try {
			Worker worker = new Worker(9, "Satya", "Sri", 750000,Date.valueOf("2022-04-24"), "SDE", "bat.satya@gmail.com");
